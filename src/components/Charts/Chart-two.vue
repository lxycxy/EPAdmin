...
const chartData = {
  series: [7, 6.9, 9.5, 14.5, 18.4],
  labels: ['道路工程', '水利工程', '房建工程', '管廊工程', '绿化工程']
}
...
const apexOptions = {
  ...
  colors: ['#3C50E0', '#6577F3', '#8FD0EF', '#0FADCF', '#4ACDCF'],
...
<template>
  ...
  >
    <div class="mb-3 justify-between gap-4 sm:flex">
      <div>
        <h4 class="text-sm font-bold text-black dark:text-white">项目分类情况</h4>
      </div>
    </div>
    <div class="mb-2">
